export default function Navbar({ appMode, setAppMode, view, setView, status, onReset }) {
  return (
    <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-white/90 px-4 md:px-6 py-3">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="font-extrabold text-xl tracking-tight text-gray-900" style={{ fontFamily: "Syne, sans-serif" }}>
            QuickPrint
          </span>
          <span
